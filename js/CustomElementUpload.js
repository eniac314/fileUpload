...
var author$project$CustomElementUpload$init = function (flags) {
	return _Utils_Tuple2(
		{debug: elm$core$Maybe$Nothing, id: 'InputId', mFile: elm$core$Maybe$Nothing},
		elm$core$Platform$Cmd$none);
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$CustomElementUpload$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(_List_Nil);
};
var author$project$CustomElementUpload$UploadResult = function (a) {
...
var author$project$CustomElementUpload$fileUploadRequest = function (_n0) {
...
var author$project$CustomElementUpload$uploadFile = function (file) {
	return A2(
		elm$http$Http$send,
		author$project$CustomElementUpload$UploadResult,
		author$project$CustomElementUpload$fileUploadRequest(file));
};
var author$project$CustomElementUpload$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UploadFile':
				var _n1 = model.mFile;
				if (_n1.$ === 'Nothing') {
					...
					return _Utils_Tuple2(
						model,
						author$project$CustomElementUpload$uploadFile(file));
				}
			case 'FileRead':
				var data = msg.a;
				var newFile = {contents: data.contents, filename: data.filename};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							mFile: elm$core$Maybe$Just(newFile)
						}),
					elm$core$Platform$Cmd$none);
			default:
				if (msg.a.$ === 'Ok') {
...
var author$project$CustomElementUpload$UploadFile = {$: 'UploadFile'};
var author$project$CustomElementUpload$FileData = F2(
	function (contents, filename) {
		return {contents: contents, filename: filename};
	});
var author$project$CustomElementUpload$FileRead = function (a) {
	return {$: 'FileRead', a: a};
};
...
var author$project$CustomElementUpload$decodeFileData = A2(
	elm$json$Json$Decode$at,
	_List_fromArray(
		['target', 'fileData']),
	A2(
		elm$json$Json$Decode$map,
		author$project$CustomElementUpload$FileRead,
		A3(
			elm$json$Json$Decode$map2,
			author$project$CustomElementUpload$FileData,
...
var author$project$CustomElementUpload$fileReader = function (attributes) {
	return A3(
		elm$html$Html$node,
		'file-reader',
		attributes,
...
var author$project$CustomElementUpload$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$CustomElementUpload$fileReader(
						_List_fromArray(
							[
								elm$html$Html$Attributes$id(model.id),
								A2(elm$html$Html$Events$on, 'fileRead', author$project$CustomElementUpload$decodeFileData)
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$CustomElementUpload$UploadFile)
							]),
						_List_fromArray(
							[
...
var author$project$CustomElementUpload$main = elm$browser$Browser$element(
	{init: author$project$CustomElementUpload$init, subscriptions: author$project$CustomElementUpload$subscriptions, update: author$project$CustomElementUpload$update, view: author$project$CustomElementUpload$view});
_Platform_export({'CustomElementUpload':{'init':author$project$CustomElementUpload$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"CustomElementUpload.Msg","aliases":{"CustomElementUpload.FileData":{"args":[],"type":"{ contents : String.String, filename : String.String }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"CustomElementUpload.Msg":{"args":[],"tags":{"UploadFile":[],"FileRead":["CustomElementUpload.FileData"],"UploadResult":["Result.Result Http.Error ()"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));